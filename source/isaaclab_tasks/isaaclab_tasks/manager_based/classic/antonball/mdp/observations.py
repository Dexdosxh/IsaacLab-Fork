...
def base_up_proj(env: ManagerBasedEnv, asset_cfg: SceneEntityCfg = SceneEntityCfg("robot")) -> torch.Tensor:
    ...
    base_up_vec = math_utils.quat_apply(asset.data.root_quat_w, -asset.data.GRAVITY_VEC_W)
...
def object_pose_rel_b(env: ManagerBasedEnv, object_name: str, asset_cfg: SceneEntityCfg = SceneEntityCfg("robot")) -> torch.Tensor:
    ...
    asset: Articulation = env.scene[asset_cfg.name]
    return math_utils.quat_apply_inverse(asset.data.root_quat_w, obj.data.root_pos_w - asset.data.root_pos_w)
...
def object_lin_vel_rel_b(env: ManagerBasedEnv, object_name: str, asset_cfg: SceneEntityCfg = SceneEntityCfg("robot")) -> torch.Tensor:
    ...
    obj: RigidObject = env.scene[object_name]
    asset: Articulation = env.scene[asset_cfg.name]
    return math_utils.quat_apply_inverse(asset.data.root_quat_w, obj.data.root_lin_vel_w-asset.data.root_lin_vel_w)
...
def object_quat(env: ManagerBasedEnv, object_name: str, asset_cfg: SceneEntityCfg = SceneEntityCfg("robot")) -> torch.Tensor:
